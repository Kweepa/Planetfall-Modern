...
<OBJECT ADVENTURER
	(LOC DECK-NINE)
	(SYNONYM ADMIRAL SMITHERS SPAM EGGS)
...
<ROUTINE DIARY-BUTTON-F ()
	 <COND (<AND <VERB? PUSH-UP>   <EQUAL? ,HERE ,UPPER-ELEVATOR ,LOWER-ELEVATOR>> <PERFORM V?PUSH-UP   ,ELEVATOR-BUTTON> <RTRUE>)>
	 <COND (<AND <VERB? PUSH-DOWN> <EQUAL? ,HERE ,UPPER-ELEVATOR ,LOWER-ELEVATOR>> <PERFORM V?PUSH-DOWN ,ELEVATOR-BUTTON> <RTRUE>)>
	 <COND (<VERB? PUSH>
		<COND (<FSET? ,DIARY ,ACTIVEBIT>
